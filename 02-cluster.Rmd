...
```{r}
<<<<<<< Updated upstream:02-Cluster-Analysis.Rmd
...
>>>>>>> Stashed changes:02-cluster.Rmd
```
...
- **Sum of squares **: This method relies on minimizing the within cluster variance and increasing between cluster variance. 
```{r}
...
```{r include=FALSE}
knitr::include_graphics("images/BIC_latest.png")
```
